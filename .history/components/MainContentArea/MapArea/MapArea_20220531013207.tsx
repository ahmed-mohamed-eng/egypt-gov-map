...
export interface MapAreaProps extends MapImageProps {}
...
export const MapArea = (props: MapAreaProps) => {
  return (
    <VStack
      ...
      spacing="0.5rem"
    >
      <MapImage mapAreas={props.mapAreas} mapImageSrc={props.mapImageSrc} />
      <MapInfoDisplayedLinks breadcrumbItems={provinces} />
    </VStack>
  );
};
